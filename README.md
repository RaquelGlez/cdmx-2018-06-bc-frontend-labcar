...
Como parte de una actividad de repaso de maquetación, se lleva a cabo la replicación de la siguiente página web.
...
- Y modal de Convierte en conductor
  ...
  Las imágenes que son necesarias se encuentran [aquí](https://github.com/Laboratoria-learning/lab-car-boilerplate).
